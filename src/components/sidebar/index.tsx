...
const TaskmasterIcon = () => (
    ...
    >
        <path
            d="M7.5 15.75H3.75C3.35218 15.75 2.97064 15.592 2.68934 15.3107C2.40804 15.0294 2.25 14.6478 2.25 14.25V3.75C2.25 3.35218 2.40804 2.97064 2.68934 2.68934C2.97064 2.40804 3.35218 2.25 3.75 2.25H7.5"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
...
const Sidebar: React.FC<{ onNewTask: () => void }> = ({ onNewTask }) => {
    ...
    return (
        <>
            ...
            <div className="sidebar-hitbox" onMouseEnter={handleMouseEnter} />
