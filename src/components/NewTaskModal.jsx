                    ...
                    <div className="task-settings-container">
                        <div className="form-group">
                            <div className="task-type-switch">
                                <span className={formData.task_type === 'work' ? 'active' : ''}>Work</span>
                                <label className="switch">
                                    <input
                                        type="checkbox"
                                        checked={formData.task_type === 'passion'}
                                        onChange={handleTaskTypeChange}
                                    />
                                    <span className="slider"></span>
                                </label>
                                <span className={formData.task_type === 'passion' ? 'active' : ''}>Passion</span>
                            </div>
                        </div>
                        ...
                        {formData.task_type === 'work' ? (
                            ...
                            <div className="form-group">
                                ...
                                <div className="leniency-buttons">
                                    {['asap', 'soon', 'eventually'].map((option) => (
                                        <button
                                            key={option}
                                            type="button"
                                            className={`leniency-button ${formData.leniency === option ? 'active' : ''}`}
